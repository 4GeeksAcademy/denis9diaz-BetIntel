...
export const Home = () => {
	return (
		<div className="home-container">
			...
			{/* Sección de Creación de Pronósticos */}
			...
			<section className="home-stats">
				<div className="container">
					...
					<p className="text-home">Analiza tus resultados y toma decisiones más informadas con nuestras herramientas de estadísticas avanzadas.</p>
					<a href="/stats" className="btn btn-primary">Ver Estadísticas</a>
				</div>
			</section>

			{/* Sección de Mejores Usuarios */}
			<section className="home-top-users">
				<div className="container">
					<h2 className="rankings-title-home">Los mejores pronosticadores</h2>
					<a href="/stats" className="btn btn-primary">Ranking</a>
				</div>
			</section>
		</div>
	);
